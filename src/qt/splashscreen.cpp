    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText3   = QChar(0xA9)+QString(" %1 ").arg(2021) + QString(tr("Vakilcoin Developer"));
    ...
    pixPaint.drawText(paddingLeftCol2,paddingTopCol2+line3+line4,versionText);
